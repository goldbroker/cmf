...
cmf_functional_tests: functional_tests_block functional_tests_content functional_tests_core functional_tests_media functional_tests_menu functional_tests_resource functional_tests_resource_rest functional_tests_seo functional_tests_sonata_phpcr_admin_integration
...
functional_tests_seo:
	@vendor/bin/simple-phpunit --configuration phpunit.xml.dist.seo --testsuite "functional tests" tests/Bundle/SeoBundle
