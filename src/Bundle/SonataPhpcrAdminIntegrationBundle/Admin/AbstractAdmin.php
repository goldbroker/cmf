...
abstract class AbstractAdmin extends Admin
{
     ...
     * @param $fieldName
     */
    public function addTransformerToField(FormBuilderInterface $formBuilder, $fieldName)
    {
        $formBuilder
            ->get($fieldName)
            ->addModelTransformer(
                new DocumentToPathTransformer($this->managerRegistry->getManagerForClass($this->getClass()))
            );
    }
}
