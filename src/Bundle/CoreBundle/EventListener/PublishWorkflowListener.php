...
{
    protected PublishWorkflowChecker $publishWorkflowChecker;

    /**
     * The attribute to check with the workflow checker, typically VIEW or VIEW_ANONYMOUS.
     */
    private string $publishWorkflowPermission;

    public function __construct(PublishWorkflowChecker $publishWorkflowChecker, string $attribute = PublishWorkflowChecker::VIEW_ATTRIBUTE)
    {
