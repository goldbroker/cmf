...
namespace Tests\Symfony\Cmf\Bundle\SeoBundle\Fixtures\App\DataFixtures\Phpcr;
...
use Tests\Symfony\Cmf\Bundle\SeoBundle\Fixtures\App\Document\AlternateLocaleContent;
use Tests\Symfony\Cmf\Bundle\SeoBundle\Fixtures\App\Document\ContentWithExtractors;
...
class LoadContentData implements FixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $route->setDefault('_controller', 'Tests\Symfony\Cmf\Bundle\SeoBundle\Fixtures\App\Controller\TestController::indexAction');
        ...
        $alternateLocaleRoute->setDefault(
            '_controller',
            'Tests\Symfony\Cmf\Bundle\SeoBundle\Fixtures\App\Controller\TestController::indexAction'
        );
