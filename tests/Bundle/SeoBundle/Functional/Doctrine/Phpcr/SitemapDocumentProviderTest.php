...
namespace Tests\Symfony\Cmf\Bundle\SeoBundle\Functional\Doctrine\Phpcr;
...
class SitemapDocumentProviderTest extends BaseTestCase
{
    ...
    public function setUp()
    {
        ...
        $this->db('PHPCR')->loadFixtures(
            ['Tests\Symfony\Cmf\Bundle\SeoBundle\Fixtures\App\DataFixtures\Phpcr\LoadSitemapData']
        );
