...
namespace Tests\Symfony\Cmf\Bundle\SeoBundle\Unit\Form\Type;
...
{
    public function __construct(string $dataClass = \Symfony\Cmf\Bundle\SeoBundle\Model\SeoMetadata::class)
    {
