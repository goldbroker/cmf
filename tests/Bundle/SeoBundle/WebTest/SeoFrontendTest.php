...
namespace Tests\Symfony\Cmf\Bundle\SeoBundle\WebTest;
...
class SeoFrontendTest extends BaseTestCase
{
    public function setUp(): void
    {
        ...
        $this->db('PHPCR')->loadFixtures([
            'Tests\Symfony\Cmf\Bundle\SeoBundle\Fixtures\App\DataFixtures\Phpcr\LoadContentData',
        ]);
    }
    ...
    public function testDefaultUsage()
    {
        ...
        $actualMeta = $metaCrawler->extract(['content']);
        $expectedMeta = [
