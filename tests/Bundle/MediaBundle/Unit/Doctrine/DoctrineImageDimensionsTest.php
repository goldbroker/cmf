...
namespace Tests\Symfony\Cmf\Bundle\MediaBundle\Unit\Doctrine;
...
class DoctrineImageDimensionsTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testUpdateDimensionsFromContent($content)
    {
        ...
        if ($fileSize) {
            ...
            $expectedWidth = 0;
            $expectedHeight = 0;
            $expectedContentType = 'application/x-empty';
            $expectedSize = 0;
        }
