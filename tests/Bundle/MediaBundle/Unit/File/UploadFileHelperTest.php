...
namespace Tests\Symfony\Cmf\Bundle\MediaBundle\Unit\File;
...
class UploadFileHelperTest extends \PHPUnit\Framework\TestCase
{
    /**
    ...
    public function testHandleUploadedFile($options)
    {
        ...
        $uploadedFile = new UploadedFile($testFile, 'test.txt', null, $options['upload_error'], $options['allow_non_uploaded_file']);
    ...
    public function testHandleUploadedFileException()
    {
        ...
        $uploadFileHelper = $this->getUploadFileHelper();
        $uploadedFile = new UploadedFile($testFile, 'test.txt', null, null, true);
    ...
    public function testGetUploadedResponse()
    {
        ...
        $request = new Request();
        $request->files->set('file', new UploadedFile($testFile, 'test.txt', null, null, true));
